...
return [
    ...
    'connections' => [
        'mysql' => [
            'driver' => 'mysql', 'url' => env('DB_URL'), 'host' => env('DB_HOST', 'mysql'),
            'port' => env('DB_PORT', '3306'), 'database' => env('DB_DATABASE', 'limenora'),
            'username' => env('DB_USERNAME', 'limenora'), 'password' => env('DB_PASSWORD'),
