...
## Eerste werkende slice

Registreren en e-mail bevestigen → beheerder via console → medewerkersuitnodiging → medewerker bevestigt en activeert MFA → professioneel profiel → conceptprogramma → andere beoordelaar publiceert → gebruiker volgt een vaste versie en bewaart voortgang.
...
Deze stap bevat geen productiehost, domeinkoppeling, openbare lancering, echte SMTP-provider, betaalaccount of medische dossiers. Docker en de localhost-poorten zijn uitsluitend voor de ontwikkelcomputer. Overige platformen en repositories zijn niet gewijzigd.
